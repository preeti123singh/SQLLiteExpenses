    ...
    <body style="padding: 0px;">
        <form id="form1" runat="server">
            ...
            <div style="height: 50px;">
                ...
                <asp:Button ID="btn_Pdf" runat="server" Text="Expense Export" OnClick="btn_Pdf_Click" />
                <asp:Button ID="btn_Pdf_Vat" runat="server" OnClick="btn_Pdf_Vat_Click" Text="Vat Export" />
            </div>
            <div>
                <asp:Label ID="lbl_image" runat="server" Text=""></asp:Label><asp:Label ID="lbl_vat" runat="server" Text=""></asp:Label></div>
